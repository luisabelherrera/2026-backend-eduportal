...
import com.example.demo.repositories.jpa.NoticiaRepository;
...
public class NoticiaController {
    ...
    @GetMapping("/video/{id}")
    public ResponseEntity<byte[]> obtenerVideoNoticia(@PathVariable Long id) {
        Noticia noticia = noticiaService.obtenerNoticiaPorId(id);
    ...
    @PutMapping("/{id}/likes")
    public Noticia updateLikes(@PathVariable Long id, @RequestBody Map<String, List<String>> body) {
    ...
    public ResponseEntity<Noticia> darLike(@PathVariable Long id) {
